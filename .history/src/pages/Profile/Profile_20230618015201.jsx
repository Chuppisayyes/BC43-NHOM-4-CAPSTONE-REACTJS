                ...
                <div className="container">
                    ...
                    <div className="row">
                        ...
                        <div className="col-8 detail-profile">
                            <div className="info">
                                <span>Tên:</span>
                                <input type="text" placeholder={userProfile.name}/>
                            </div>
                            <div className="info">
                                <span>Giới Tính:</span>
                                <select name="" id="" placeholder={userProfile.gender}>
                            ...
                            <div className="info">
                                <span>Phone:</span>
                                <input type="text"  placeholder={userProfile.phone} />
                            </div>
                            <div className="info">
                                <span>Email:</span>
                            ...
                            <div className="info">
                                <span>Password:</span>
                                <input type="text" placeholder={userProfile.password} />
                            </div>
