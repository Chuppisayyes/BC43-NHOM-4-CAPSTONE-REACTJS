                        ...
                        <div className='row'>
                            <div className='col-6'>
                                <div className='form-group'>
                                    <p>Id</p>
                                    <input data-type="number" className='form-control' id="idProduct" name="idProduct"  value={idProduct} />
                                    <p className='text text-danger'></p>
                                </div>
                                <div className='form-group'>
                                    <p>name</p>
                                    <input data-type="string" className='form-control' id="name" name="name"  value={name} />
                                    <p className='text text-danger'></p>
                                </div>
                                <div className='form-group'>
                                    <p>price</p>
                                    <input data-type="number" className='form-control' id="price" name='price'  value={price} />
                                    <p className='text text-danger'></p>
                                </div>
                            </div>
                            <div className='col-6'>
                                <div className='form-group'>
                                    <p>img</p>
                                    <input className='form-control' id="img" name='img' value={img} />
                                    <p className='text text-danger'></p>
                                </div>
                                <div className='form-group'>
                                    <p>type</p>
