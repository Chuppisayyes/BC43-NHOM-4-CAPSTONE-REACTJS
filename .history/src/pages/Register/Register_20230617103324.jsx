                ...
                <div className="container">
                    ...
                    <div className="form_input">
                        ...
                        <div className="gender">
                            ...
                            <label>
                            <input className='form-check-input' id="gender1" name='gender' type='radio' value={true} onInput={registerFrm.handleChange} onBlur={registerFrm.handleBlur}  />
                                <span className="checkmark" />Male
                            </label>
                            <label>
                            <input className='form-check-input' id="gender2" name='gender' type='radio' value={false} onInput={registerFrm.handleChange} onBlur={registerFrm.handleBlur}  />
