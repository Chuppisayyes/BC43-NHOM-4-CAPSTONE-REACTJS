            ...
            <section id="body">
                <div className="container">
                    ...
                    <div className="form_input">
                        <div className="form">
                            <input type="text" className="form-control" placeholder="Email" id="email" name='email' onInput={registerFrm.handleChange} />
                            <span id="error-email" />
                            <span id="error-required-email" />
                        </div>
                        <div className="form">
                            <input type="text" className="form-control" placeholder="Name" id="name" name='name' onInput={registerFrm.handleChange} />
                            <span id="error-name" />
                            <span id="error-required-name" />
                        </div>
                        <div className="form">
                            <input type="password" className="form-control" placeholder="Password" name='password' id="pass" onInput={registerFrm.handleChange} />
                            <span id="error-pass" />
                            <span id="error-required-pass" />
                        </div>
                        <div className="form">
                            <input type="text" className="form-control" placeholder="Phone" id="phone" name='phone' onInput={registerFrm.handleChange} />
                            <span id="error-phone" />
