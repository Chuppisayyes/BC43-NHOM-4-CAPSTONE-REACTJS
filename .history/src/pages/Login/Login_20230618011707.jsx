...
import { loginActionApi } from '../../redux/';
    ...
    return (
        <div>
            ...
            <div className="form-modal">
                <form className="form_container" onSubmit={frmLogin.handleSubmit}>
                    ...
                    <div className="input_container">
                        ...
                        <input placeholder=". . . @gmail.com" title="Inpit title" name="email" type="text" className="input_field" id="email" onInput={frmLogin.handleChange} />
                    </div>
                    ...
                    <div className="input_container">
                        ...
                        <input placeholder="Password" title="Inpit title" name="password" type="password" className="input_field" id="password" onInput={frmLogin.handleChange} />
                    </div>
