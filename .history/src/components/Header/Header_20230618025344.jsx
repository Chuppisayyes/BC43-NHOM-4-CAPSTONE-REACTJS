    ...
    const renderLoginLink = () => {
        if (userLogin.email !== '') {
            ...
            return <>
                    ...
                    <NavLink className="nav-link border-bottom text-success " to="/profile">{userLogin.email}</NavLink>
                    <span className="nav-link text-white mx-3" style={{ cursor: 'pointer' }} onClick={() => {
        ...
        return <>
                 <NavLink className="nav-link border border-4 rounded" to="/login">Login</NavLink>
        </>
    }
    return (
        <div>
