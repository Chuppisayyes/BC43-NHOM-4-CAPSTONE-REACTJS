        ...
        <div>
            <footer id="footer">
                ...
                <div class="bot_content">
                    <div class="container">
                        <p className='short-content'>@ 2023 Tèo-SHOES All Rights Reserved | Design Theme by Nguyễn Hoàng Vân.</p>
                        <div class="social-menu" >
                            <ul class="social-link">
                                <li class="social-item">
                                    <a target="_blank" aria-label="Twitter" title="Twitter" data-type="click_navFooter" data-path="social:twitter" href="https://twitter.com/nhvan8624" class="social-link footer-link" data-pre="ILink">
                                ...
                                <li class="social-item">
                                    <a target="_blank" aria-label="Facebook" title="Facebook" data-type="click_navFooter" data-path="social:facebook" href="https://www.facebook.com/acwy.666" class="social-link footer-link" data-pre="ILink">
                                        <svg class="social-link-icon" width="30px" fill="#111" height="30px" viewBox="0 0 24 24">
                                ...
                                <li class="social-item">
                                    <a target="_blank" aria-label="Youtube" title="Youtube" data-type="click_navFooter" data-path="social:youtube" href="https://www.youtube.com/channel/UCBbKOIH56OTsB9dI6N_9DQQ" class="social-link footer-link" data-pre="ILink">
                                        <svg class="social-link-icon" width="30px" fill="#111" height="30px" viewBox="0 0 24 24">
                                ...
                                <li class="social-item">
                                    <a target="_blank" aria-label="Instagram " title="Instagram " data-type="click_navFooter" data-path="social:instagram" href="https://www.instagram.com/yaang_2486/" class="social-link footer-link" data-pre="ILink">
                                        <svg class="social-link-icon" width="30px" fill="#111" height="30px" viewBox="0 0 24 24">
...
export default connect(mapStateToProps)(FooterBasic)